...
class TokenManager(private val context: Context) {
    ...
    suspend fun saveAccessToken(token: String) {
        try {
            ...
            Log.e(TAG, "Failed to encrypt or save the token. Cause: ${e.message}", e)
        }
    }
    ...
    suspend fun updateTokens(refreshToken: String,accessToken: String){
        ...
        try {
            ...
            Log.e(TAG,"failed saving tokens${e.message}")
        }
    }
    ...
    fun getAccessTokenSync(): String? {
        return runBlocking {
            ...
            try {
                ...
                Log.e(TAG, " Failed to decrypt token. It may be corrupted. Cause: ${e.message}", e)
                null
            }
        }
    }
    ...
    suspend fun clearSession() {
        try {
            ...
            Log.e(TAG, "Failed to clear the vault. Cause: ${e.message}", e)
        }
    }
}